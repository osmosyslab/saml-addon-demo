...
package com.company.samladdonreferenceproject;
...
public class SamladdonreferenceprojectTestContainer extends TestContainer {

    public SamladdonreferenceprojectTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/samladdonreferenceproject/app.properties",
    ...
    public static class Common extends SamladdonreferenceprojectTestContainer {

        public static final SamladdonreferenceprojectTestContainer.Common INSTANCE = new SamladdonreferenceprojectTestContainer.Common();
